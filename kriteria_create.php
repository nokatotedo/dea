            ...
            <div class="card-body">
              ...
              <form class="row mt-3" method="post">
                ...
                <div class="col-6 mb-6">
                  ...
                  <input type="number" class="form-control" id="bobot" name="bobot" step="0.01" min="0" required>
                </div>
                <div class="d-flex justify-content-end gap-2">
                  <a href="kriteria_create.php" class="btn btn-danger">Reset</a>
