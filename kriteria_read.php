<?php
  ...
  if(isset($_POST['search'])) {
    ...
    search_kriteria($search);
  }

  $head = ["No.", "Kode Kriteria", "Nama Kriteria", "Jenis", "Bobot", "Aksi"];
  $data = [];
  $keyword = '';
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
              <a href="kriteria_create.php" class="btn btn-outline-danger m-1">
